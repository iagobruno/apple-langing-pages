import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineComponent, ref, inject, h, Suspense, Fragment, useSSRContext, createApp, provide, shallowReactive, mergeProps, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, getCurrentScope, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const _routes = [
  {
    name: "iphone",
    path: "/iphone",
    component: () => import('./iphone-2tAI9bz9.mjs')
  },
  {
    name: "airpods",
    path: "/airpods",
    component: () => import('./airpods-DuVd83Mj.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CGxSLEqp.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-3nJ3N6IU.mjs'));
